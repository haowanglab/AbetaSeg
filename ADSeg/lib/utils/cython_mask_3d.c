...
static const char __pyx_k_Created_on_21_05_30_4_50_IDE_Py[] = "\nCreated on 21-05-30 \344\270\213\345\215\2104:50\nIDE PyCharm\n\n@author: Zhiyi\n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cython_mask_3d",
    __pyx_k_Created_on_21_05_30_4_50_IDE_Py, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_mask_3d", __pyx_methods, __pyx_k_Created_on_21_05_30_4_50_IDE_Py, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
