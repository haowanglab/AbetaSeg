...
#__C.TEST.DETECTIONS_PER_IM = 1000 # established for 14.5M dataset
...
#For HRNet
__C.MODEL.IN_CHANNELS = 1
__C.MODEL.EXTRA = AttrDict()
__C.MODEL.EXTRA.STEM_INPLANES = 48
...
__C.MODEL.EXTRA.STAGE2.NUM_BLOCKS = [1,1]
__C.MODEL.EXTRA.STAGE2.NUM_CHANNELS = [6,12]
...
__C.MODEL.EXTRA.STAGE3.NUM_BLOCKS = [1,1,1]
__C.MODEL.EXTRA.STAGE3.NUM_CHANNELS = [6,12,24]
...
__C.MODEL.EXTRA.STAGE4.NUM_BLOCKS = [1,1,1,1]
__C.MODEL.EXTRA.STAGE4.NUM_CHANNELS = [6,12,24,48]
