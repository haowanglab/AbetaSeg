...
DATASETS = {
    'AD_det_seg_train': {
        IM_DIR:
            '/data/zhiyi/AD_BrainImage/Train_125_select/set1/image',
        ANN_DIR:
            '/data/zhiyi/AD_BrainImage/Train_125_select/set1/label',

        # IM_DIR:
        #     '/home/zhiyi/Data/AD_BrainImage/11_2/set1/image',
        # ANN_DIR:
        #     '/home/zhiyi/Data/AD_BrainImage/11_2/set1/label',
    },
    'coco_2014_train': {
        IM_DIR:
