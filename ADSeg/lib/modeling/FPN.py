...
#import torch.nn.functional as F #5.1 change
        ...
        for lvl in range(k_min, k_max + 1):
            ...
            if not self.training or cfg.MODEL.FASTER_RCNN:
                ...
                if cfg.RPN.CLS_ACTIVATION == 'softmax':
                    ...
                    #fpn_rpn_cls_probs = F.sigmoid(fpn_rpn_cls_score) #5.1 change
                    fpn_rpn_cls_probs = torch.sigmoid(fpn_rpn_cls_score) #5.1 change
