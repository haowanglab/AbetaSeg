...
class dsn_body(nn.Module):
    def __init__(self):
        ...
        # self.conv4b = nn.Conv3d(128, 128, 3, 1, 1, bias = True)
        # self.bn4b = nn.BatchNorm3d(128, momentum = 0.001, affine = True)
        # self.conv5b = nn.Conv3d(128, 128, 3, 1, 1, bias = True)
        # self.bn5b = nn.BatchNorm3d(128, momentum = 0.001, affine = True)
        if cfg.RPN.STRIDE == 8:
    ...
    def forward(self, main):
        ...
        # main = nnf.relu(self.bn5b(self.conv5b(main)))
        if cfg.RPN.STRIDE == 8:
