...
from core.config import cfg, cfg_from_file, cfg_from_list, assert_and_infer_cfg, merge_cfg_from_file
# from config.cfg import merge_from_file
...
def main():
    ...
    if DEBUG:
        args.dataset = 'AD'
        args.cfg_file = '../configs/AD22/e2e_mask_rcnn_AD22.yaml'
        args.num_workers = 0
        args.batch_size = 2
    ...
    if args.dataset == "coco2017":
        ...
        cfg.TRAIN.DATASETS = ('AD_det_seg_train',)
        cfg.MODEL.NUM_CLASSES = 2
    else:
    ...
    # summary(maskRCNN, input_size=(128, 256, 256))
    ...
    try:
        ...
        for step in range(args.start_step, cfg.SOLVER.MAX_ITER):
            ...
            for inner_iter in range(args.iter_size):
                ...
                # net_outputs = maskRCNN(torch.tensor(**input_data)) #1024
